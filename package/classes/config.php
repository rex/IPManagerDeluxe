...
define('SITE_NAME','Gazelle Enhanced'); //The name of your site
define('NONSSL_SITE_URL','gazelle.refreshedweb.com'); //The FQDN of your site
define('SSL_SITE_URL','gazelle.refreshedweb.com'); //The FQDN of your site, make this different if you are using a subdomain for ssl
...
define('SERVER_ROOT','/path/to/gazelle'); //The root of the server, used for includes, purpose is to shorten the path string
...
define('SQLDB','gazelle_enhanced'); //The MySQL database to use
